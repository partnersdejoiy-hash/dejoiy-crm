// Extensions where Dejoiy intentionally deviates from the IANA-standard mime
// mapping returned by mrmime. Dejoiy's storage layer persists these values
...
//                which predates TypeScript. `.tsx` is unregistered. Dejoiy uses
...
// mime AND (2) Dejoiy actually writes that extension via FileStorageService AND
